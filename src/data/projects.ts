...
export const STATIC_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tech_stack: ['C#', '.NET', 'MS SQL'],
    contribution:
      '參與倉儲流程功能開發，設計 backend service 並優化資料庫查詢效能。',
    order: 2,
    created_at: new Date().toISOString(),
  },
  {
    ...
    contribution:
      '獨立負責全端架構與 UI/UX 實作。前端使用 Riverpod 管理複雜的跨頁面表單狀態，並結合 GoRouter 實作 Auth Guard 路由攔截；後端使用 Supabase (PostgreSQL) 設計正規化資料庫，並嚴格設定 RLS (Row Level Security) 確保多用戶資料隔離與資安。',
    order: 3,
    created_at: new Date().toISOString(),
  },
  {
    ...
    description:
      '企業級個人財務管理平台，捨棄傳統記帳思維，實現現金流預測、分期攤銷自動化與動態預算管理。具備歷史資料遷移引擎，可無痛匯入主流記帳 App 資料。',
    tech_stack: [
      'Vue 3',
      'TypeScript',
      'Supabase',
    ...
    contribution:
      '獨立設計並開發全端架構，涵蓋雙式簿記資料模型設計、週期自動帳單引擎、信用卡跨月結帳路由、未來 30 天現金流預測曲線，以及 ETL 歷史資料匯入精靈。',
    order: 4,
    created_at: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    description:
      '數位卡發卡系統，建置與維護 Google Wallet / Apple Wallet 發卡機制，提升會員數位體驗。',
  ...
  },
  {
    ...
    description:
      '透過 WXT + Vue 3 + Strapi 開發公司內部專案管理 Chrome Extension，提升團隊工作效率。',
    tech_stack: ['WXT', 'Vue 3', 'TypeScript', 'Strapi'],
    contribution:
      '負責整體架構設計與開發，串接 Strapi 後端 API，實現即時專案狀態追蹤與管理功能。',
    order: 10,
    created_at: new Date().toISOString(),
  },
  {
